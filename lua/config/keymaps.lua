...
if vim.g.vscode then
  ...
  set_keymap("n", "zc", function()
    vscode.action("editor.fold")
  end, { desc = "Fold" })
  set_keymap("n", "zo", function()
    vscode.action("editor.unfold")
  end, { desc = "Unfold" })
  set_keymap("n", "zC", function()
    vscode.action("editor.foldRecursively")
  end, { desc = "Fold Recursiverly" })
  set_keymap("n", "zO", function()
  ...
  set_keymap("n", "zv", function()
    vscode.action("editor.foldAllExcept")
  end, { desc = "Fold All Except Selected" })
  set_keymap("n", "zj", function()
    vscode.action("editor.gotoNextFold")
  end, { desc = "Go to the Next Fold" })
  set_keymap("n", "zk", function()
  ...
  end, { desc = "Search in Problems panel" })
  ...
  -- UI
  set_keymap("n", "<leader>us", function()
  ...
  set_keymap("n", "<leader>uz", function()
